...
i_sim <- read.csv(file="solo_sim_i_na.csv", row.names = 1)
j_sim <- read.csv(file="solo_sim_j_na.csv", row.names = 1)
...
setwd("/Users/Katrina/git_practice/coevolver/out_n_a")
...
write.csv(end_var, file = "nonmatching_antagonism_variance.csv")
