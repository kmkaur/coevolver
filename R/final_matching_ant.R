#Everything Needed for Matching Antagonism
...
coev_div_wrapper <- function(iter, all_pars=NULL, n.gen = 1000, 
  ...
  saveRDS(out, paste0("out_m_a/antagonism_matching_sim_", iter, ".rds"))
}
...
solo_sim_ma <- coev_div_2(all_pars = NULL, n.gen = 1000, burnin = TRUE, burnin.gen = 200, print = FALSE)
write.csv(solo_sim_ma, file = "solo_sim_ma.csv")
